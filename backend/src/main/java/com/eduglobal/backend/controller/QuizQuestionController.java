...
public class QuizQuestionController {
	...
	public ResponseEntity<List<QuizQuestionDto>> findRandomByLevel(@PathVariable Long levelId,
	...
	@PutMapping("/{id}")
	@PreAuthorize("hasRole('ADMIN')")
	public ResponseEntity<QuizQuestionDto> update(@PathVariable Long id,
			@Valid @RequestBody QuizQuestionCreateDto dto) {
